...
# TODO: 1. This only does train/dev split. How to do a proper train/dev/test split?
# TODO: 2. Can you use pre-trained embeddings, e.g., Google word2vec or GloVe, instead of the randomly initialized word embeddings? How do you handle Out-Of-Vocabulary (OOV) words?
# TODO: 3. TensorBoard visualization.
